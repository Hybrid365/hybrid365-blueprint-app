-- Hybrid 75 free challenge session logs (public /plan/[id] dashboard).
-- Run manually in Supabase SQL editor or via migration 006.
...
-- No public policies — access via service-role API routes only.
