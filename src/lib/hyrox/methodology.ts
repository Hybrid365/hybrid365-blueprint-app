...
export const HYROX_METHODOLOGY = {
  ...
  principles: [
    ...
    "Hyrox threshold progression: longer reps and shorter rest before adding speed (e.g. 5×5 → 6×5 → 6×6, week 4 deload).",
    "Saturday is usually a key/hard day for 5–6+ day athletes when available and recovery is acceptable.",
    "Lower-body strength endurance and erg threshold are hard days — avoid leg endurance the day before threshold run.",
    "Double-ready athletes: stack threshold run AM + erg threshold PM same day, then easy/recovery.",
    "Weekly training hours gates total volume — key sessions first, fill remainder with easy bike/erg/support.",
    "Station EMOMs attach to strength/Hyrox hard days — not default easy aerobic days.",
    "Tempo/aerobic quality before multiple true threshold sessions — do not over-classify tempo as threshold.",
    "Station weaknesses from assessment directly change weekly focus and add-ons (rotate across 4-week block).",
