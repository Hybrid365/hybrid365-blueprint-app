...
export function MockAthletesPanel() {
  return (
    <>
      <div className="mb-3 rounded-lg border border-zinc-700/80 bg-zinc-900/50 px-3 py-2 text-xs text-zinc-400">
        <span className="font-semibold text-zinc-300">Mock data</span> — programme builder demo
        athletes ({COACH_ATHLETES.length}). Not linked to Supabase yet.
      </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-zinc-500">
                    {a.raceDate} · B{a.programmeBlock} W{a.blockWeek}
                  </p>
