...
import { HYBRID_PERFORMANCE_TRACK_RESULTS } from "@/app/lib/hybrid-performance-track/hybridPerformanceTrackStory";
...
export function HybridPerformanceTrackResults() {
  const copy = HYBRID_PERFORMANCE_TRACK_RESULTS;
  const studies = getCaseStudiesForSurface("hybrid-performance-track");
      ...
      <div className="mx-auto max-w-[1200px]">
        <div className="mb-4 flex items-end justify-between gap-4">
          <div className="min-w-0">
            <p className="mb-1.5 text-[10px] font-bold uppercase tracking-[0.2em] text-[#f4d23c] sm:text-[11px]">
              {copy.eyebrow}
            </p>
            <h2 className="font-black uppercase leading-[0.9] tracking-[-0.045em] text-white text-[clamp(1.35rem,3.8vw,1.95rem)]">
              {copy.headline}
            </h2>
            <p className="mt-2 max-w-2xl text-[12px] leading-snug text-white/42 sm:text-[13px]">
              {copy.supporting}
            </p>
          </div>
        ...
        <div
          ...
          tabIndex={0}
          role="region"
          aria-label="Hybrid365 method results"
