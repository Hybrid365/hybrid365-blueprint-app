import { HYBRID_PERFORMANCE_IDENTITY } from "@/app/lib/hybrid-performance/hybridPerformanceStory";
import {
  HomepageEyebrow,
  HomepageHeading,
  HomepageSection,
...
export function HybridPerformanceIdentity() {
  const copy = HYBRID_PERFORMANCE_IDENTITY;
