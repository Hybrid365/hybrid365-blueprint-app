  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        <span
          className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-yellow-500/25 bg-yellow-400/10"
          aria-hidden
        >
        ...
        <div className="min-w-0 flex-1">
          ...
          {hasInsight ? (
            <p className="mt-2 text-sm leading-relaxed text-zinc-200">&ldquo;{insight}&rdquo;</p>
          ) : (
          ...
          <div className="mt-3 flex flex-wrap items-center gap-2 text-xs text-zinc-500">
            ...
            {weekRole ? <span>· {weekRole}</span> : null}
          </div>
          {tags.length > 0 ? (
